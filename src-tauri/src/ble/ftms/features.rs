use super::types::{
    AVERAGE_CADENCE_FLAG, AVERAGE_POWER_FLAG, AVERAGE_SPEED_FLAG, ELAPSED_TIME_FLAG,
    EXPENDED_ENERGY_FLAG, Feature, FeatureVal, HEART_RATE_FLAG, INSTANTANEOUS_CADENCE_FLAG,
